...
7. 注意修改代码`main.py`中的参数设置，记得在跑代码之前使用 `nvidia-smi` 查看可用的GPU `CUDA_VISIBLE_DEVICES=2 python main.py --cuda cuda:0 --mode test --dataset sysu --output_path ckp/sysu410/base`